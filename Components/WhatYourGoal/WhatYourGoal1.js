...
const WhatYourGoal1 = ({navigation}) => {
  return (
    <ScrollView style={styles.mainContainer}>
      <View style={styles.bodyContainer}>
        ...
        <View style={styles.middleCardContainer}>
          ...
          <LinearGradient
            ...
            <Image
              source={require('../assets/whatisyourgoal1.png')}
              style={{alignSelf: 'center'}}
            />

            <View style={styles.bottomTextContainer}>
              <Text style={styles.bottomMainText}>Improve Shape</Text>
      ...
      <View>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('WhatYourGoal2')}>
          <LinearGradient
            start={{x: 0, y: 0}}
            end={{x: 1, y: 0}}
            colors={['#9DCEFF', '#92A3FD']}
