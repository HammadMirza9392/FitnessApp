...
const BreakFast = ({navigation}) => {
  ...
  const rendorRecDiet = (item, index) => {
    let bgcolor,
      btncolor = 'gray';
    let stwch = index % 2 == 0 ? 0 : 1;
    ...
    return (
      <TouchableOpacity
        ...
        style={[styles.RecDietContainer, {backgroundColor: bgcolor}]}>
        <View>
        ...
        <TouchableOpacity
          style={[styles.RecDietButtonContainer, {backgroundColor: btncolor}]}
    ...
    <ScrollView style={styles.mainContainer}>
      <View style={styles.bodyContainer}>
        <View style={styles.TopHeader}>
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate('BlueBerryPanCake')}>
            <Image
        ...
        <View style={{marginBottom: 10}}>
          <FlatList
            data={RecDietData}
            horizontal={true}
            renderItem={({item, index}) => rendorRecDiet(item, index)}
            style={{width: '100%'}}
          />
        </View>
        ...
        <View>
          <FlatList
            ...
            renderItem={({item, index}) => rendorPopularMeal(item, index)}
            style={{width: '100%'}}
          />
        </View>
      </View>
