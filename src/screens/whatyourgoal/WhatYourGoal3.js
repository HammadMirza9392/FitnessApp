...
const WhatYourGoal3 = ({navigation}) => {
  return (
      ...
      <View style={styles.bodyContainer}>
        ...
        <View style={styles.middleCardContainer}>
          ...
          <LinearGradient
            ...
            <Image
              source={require('./../../assets/whatisyourgoal3.png')}
              style={{alignSelf: 'center'}}
            />

            <View style={styles.bottomTextContainer}>
              <Text style={styles.bottomMainText}>Lose a Fat</Text>
              <View style={styles.horzintalLine}></View>
              <Text style={styles.bottomSubText}>
                I have over 20 lbs to lose. I want to drop all this fat and gain
                muscle mass
              </Text>
            </View>
          </LinearGradient>
